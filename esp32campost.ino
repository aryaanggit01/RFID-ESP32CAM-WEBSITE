...
String serverName = "lab-android.com";   // OR REPLACE WITH YOUR DOMAIN NAME

String serverPath = "/WebAbsen.php";//"/prototype/WebAbsen/upload.php";     // The default serverPath should be upload.php
